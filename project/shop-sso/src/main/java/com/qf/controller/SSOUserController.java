...
public class SSOUserController {
    ...
    public Map<String, Object> validaUsername(@RequestParam("param") String param){
...
//        })
    ...
    * */
    ...
    //, @CookieValue(name = ShopConstants.ANON_ID, required = false) String anonId
    @RequestMapping("/loginUser")
    public ResultEntity loginUser(@RequestParam("username")  String username, @RequestParam("password")  String password ,@CookieValue(name = ShopConstants.ANON_ID, required = false) String anonId) {
